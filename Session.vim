...
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <D-9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
